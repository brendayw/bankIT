...
//    @InjectMocks private LoanController prestamoController;
//
//    @BeforeEach
//    void setUp() {
...
//    private Loan crearPrestamo(long dni, double monto, int plazo, int pagos, double saldo) {
...
//        return prestamo;
//    }
//    private LoanRequestDto crearPrestamoDto(long numeroCliente, double monto, String tipoMoneda, int plazo) {
//        LoanRequestDto prestamo = new LoanRequestDto();
...
//    private PrestamoDetalle respuestaPrestamoDetalle(LoanStatus estado, String mensaje, List<PaymentPlan> plan) {
...
//        LoanRequestDto prestamoNuevo = crearPrestamoDto(40860006, 1000, "D", 12);
//
//        List<PaymentPlan> planPagos = new ArrayList<>();
//        for (int i = 1; i <= 12; i++) {
//            planPagos.add(new PaymentPlan(i, 167.0));
//        }
//
...
//
//        verify(prestamoService, never()).darAltaPrestamo(any(LoanRequestDto.class));
//        verify(prestamoValidator, times(1)).validatePrestamo(prestamoNuevo);
//    }
//
...
//        Loan resultado = prestamoController.obtenerPrestamoPorId(id);
//
//        assertNotNull(resultado);
...
//        long dni = 40860006;
//        Loan prestamo1 = crearPrestamo(dni, 150000.0, 12, 5, 100000.0);
//        Loan prestamo2 = crearPrestamo(dni, 100000.0, 24, 10, 50000.0);
//
...
//        List<Loan> prestamos = List.of(prestamo1, prestamo2);
//
//        when(prestamoService.buscarPrestamos()).thenReturn(prestamos);
//        List<Loan> resultado = prestamoController.obtenerPrestamos();
//
...
//        Loan resultado = prestamoController.cerrarPrestamo(id);
//        assertNotNull(resultado);
//        assertEquals(id, resultado.getId());
